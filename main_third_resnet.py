...
for class_name in os.listdir(path):
    ...
    # Autokeras를 사용하여 ResNet 아키텍처만 검색하도록 설정
    ...
    print("훈련 시작")
    clf.fit(train_img, train_label, validation_split=0.3, batch_size=5, epochs=50)

    print("모델 평가 시작!")
    eva_result = clf.evaluate(test_img, test_label)
    print(eva_result)
